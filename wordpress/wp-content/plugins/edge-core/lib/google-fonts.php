<?php
if ( ! function_exists( 'aalto_edge_init_google_fonts_array' ) ) {
    function aalto_edge_init_google_fonts_array() {
        ...
        $aalto_edge_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'aalto_edge_init_google_fonts_array');
}