			...
			vc_map(
				array(
					...
					'params'   => array(
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'out_navigation',
                            'heading'     => esc_html__( 'Pull Slider Navigation Arrows out of slider', 'edge-core' ),
                            'value'       => array_flip( aalto_edge_get_yes_no_select_array( false, true ) ),
                            'save_always' => true,
						...
						array(
							...
							'value'       => array_flip( aalto_edge_get_yes_no_select_array( false, false ) ),
							'save_always' => true,
                            'dependency'  => array('element' => 'enable_navigation', 'value' => array('no')),
							'group'       => esc_html__( 'Slider Settings', 'edge-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Below Slider', 'edge-core' ) => 'below-slider',
