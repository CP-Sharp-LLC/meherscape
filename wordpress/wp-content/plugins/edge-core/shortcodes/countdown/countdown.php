...
class Countdown implements Lib\ShortcodeInterface {
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Light', 'edge-core' )   => 'edgtf-light-skin',
							),
							'save_always' => true
						),
						array(
	...
	private function getHolderData( $params ) {
		...
		$holderData['data-month-label']  = ! empty( $params['month_label'] ) ? $params['month_label'] : esc_html__( 'Months', 'edge-core' );
		$holderData['data-day-label']    = ! empty( $params['day_label'] ) ? $params['day_label'] : esc_html__( 'Days', 'edge-core' );
		$holderData['data-hour-label']   = ! empty( $params['hour_label'] ) ? $params['hour_label'] : esc_html__( 'Hours', 'edge-core' );
		$holderData['data-minute-label'] = ! empty( $params['minute_label'] ) ? $params['minute_label'] : esc_html__( 'Minutes', 'edge-core' );
		$holderData['data-second-label'] = ! empty( $params['second_label'] ) ? $params['second_label'] : esc_html__( 'Seconds', 'edge-core' );
