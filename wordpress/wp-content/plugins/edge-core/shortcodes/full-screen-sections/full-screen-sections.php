...
class FullScreenSections implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Edge Full Screen Sections', 'edge-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'     => esc_html__( 'Enable Continuous Scrolling', 'edge-core' ),
							'description' => esc_html__( 'Defines whether scrolling down in the last section or should scroll down to the first one and if scrolling up in the first section should scroll up to the last one', 'edge-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Navigation Arrows', 'edge-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Pagination Dots', 'edge-core' ),
							'value'       => array_flip( aalto_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgtf_core_get_shortcode_module_template_part( 'templates/full-screen-sections', 'full-screen-sections', '', $params );
