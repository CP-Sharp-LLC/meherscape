...
class IconListItem implements Lib\ShortcodeInterface {
					...
					'params'   => array_merge(
						array(
                            ...
                            array(
                                ...
                                'heading'     => esc_html__( 'Inline-block display?', 'edge-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$args   = array_merge( $args, aalto_edge_icon_collections()->getShortcodeParams() );
	...
	private function getHolderClasses( $params ) {
        ...
        if($params['display_style'] === 'yes') {
            $holderClasses[] = 'edgtf-icon-list-inline-display';
        }
	...
	private function getHolderStyles( $params ) {
		...
		if ( $params['item_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . aalto_edge_filter_px( $params['item_margin'] ) . 'px';
		}
	...
	private function getIconStyles( $params ) {
		...
		if ( ! empty( $params['icon_size'] ) ) {
			$styles[] = 'font-size: ' . aalto_edge_filter_px( $params['icon_size'] ) . 'px';
		}
	...
	private function getTitleStyles( $params ) {
		...
		if ( ! empty( $params['title_size'] ) ) {
			$styles[] = 'font-size: ' . aalto_edge_filter_px( $params['title_size'] ) . 'px';
		}
		
		if ( $params['title_padding'] !== '' ) {
			$styles[] = 'padding-left: ' . aalto_edge_filter_px( $params['title_padding'] ) . 'px';
		}
