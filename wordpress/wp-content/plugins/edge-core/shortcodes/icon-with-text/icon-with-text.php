...
class IconWithText implements Lib\ShortcodeInterface {
			...
			vc_map(
				array(
					...
					'params'                    => array_merge(
						...
						aalto_edge_icon_collections()->getVCParamsArray(),
						array(
							array(
								'type'       => 'attach_image',
							...
							array(
								...
								'value'      => array(
									esc_html__( 'Normal', 'edge-core' ) => 'edgtf-normal',
									esc_html__( 'Circle', 'edge-core' ) => 'edgtf-circle',
									esc_html__( 'Square', 'edge-core' ) => 'edgtf-square'
								),
							...
							array(
								...
								'value'      => array(
									esc_html__( 'Medium', 'edge-core' )     => 'edgtf-icon-medium',
									esc_html__( 'Tiny', 'edge-core' )       => 'edgtf-icon-tiny',
									esc_html__( 'Small', 'edge-core' )      => 'edgtf-icon-small',
									esc_html__( 'Large', 'edge-core' )      => 'edgtf-icon-large',
									esc_html__( 'Very Large', 'edge-core' ) => 'edgtf-icon-huge'
								),
								'group'      => esc_html__( 'Icon Settings', 'edge-core' )
							),
							array(
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			...
			if ( ! empty( $params['custom_icon_size'] ) ) {
				$params_array['custom_size'] = aalto_edge_filter_px( $params['custom_icon_size'] ) . 'px';
			}
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = aalto_edge_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = aalto_edge_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . aalto_edge_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . aalto_edge_filter_px( $params['text_padding'] ) . 'px';
		}
	...
	private function getTitleStyles( $params ) {
		...
		if ( $params['title_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . aalto_edge_filter_px( $params['title_top_margin'] ) . 'px';
		}
