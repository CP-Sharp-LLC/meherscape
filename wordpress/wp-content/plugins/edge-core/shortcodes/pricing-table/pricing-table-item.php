...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Edge Pricing Table Item', 'edge-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'edge-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'heading'    => esc_html__( 'Title Bottom Border Color', 'edge-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Price Period Color', 'edge-core' ),
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'edge-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
