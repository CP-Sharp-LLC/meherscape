...
class PricingTable implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Edge Pricing Table', 'edge-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'value'       => array(
								esc_html__( 'One', 'edge-core' )   => 'edgtf-one-column',
								esc_html__( 'Two', 'edge-core' )   => 'edgtf-two-columns',
								esc_html__( 'Three', 'edge-core' ) => 'edgtf-three-columns',
								esc_html__( 'Four', 'edge-core' )  => 'edgtf-four-columns',
								esc_html__( 'Five', 'edge-core' )  => 'edgtf-five-columns',
							),
							'save_always' => true
						),
						array(
