...
if ( ! function_exists( 'edgtf_core_add_admin_shortcodes_styles' ) ) {
	...
	add_action( 'aalto_edge_admin_scripts_init', 'edgtf_core_add_admin_shortcodes_styles' );
}
...
if ( ! function_exists( 'edgtf_core_add_admin_shortcodes_custom_styles' ) ) {
	...
	add_action( 'aalto_edge_admin_scripts_init', 'edgtf_core_add_admin_shortcodes_custom_styles' );
}