...
class AaltoEdgeSimpleLineIcons implements iAaltoEdgeIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'aalto'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'aalto'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'aalto'),
            'icon-social-facebook'    => esc_html__('Facebook', 'aalto'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'aalto'),
            'icon-social-github'      => esc_html__('Github', 'aalto'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'aalto'),
            'icon-social-instagram'   => esc_html__('Instagram', 'aalto'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'aalto'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'aalto'),
            'icon-social-reddit'      => esc_html__('Reddit', 'aalto'),
            'icon-social-skype'       => esc_html__('Skype', 'aalto'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'aalto'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'aalto'),
            'icon-social-spotify'     => esc_html__('Spotify', 'aalto'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'aalto'),
            'icon-social-twitter'     => esc_html__('Twitter', 'aalto'),
            'icon-social-youtube'     => esc_html__('Youtube', 'aalto')
        );
    }
