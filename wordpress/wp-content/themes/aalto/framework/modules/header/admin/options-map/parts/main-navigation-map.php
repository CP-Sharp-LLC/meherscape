...
if ( ! function_exists( 'aalto_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function aalto_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'aalto_edge_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'aalto_edge_header_main_navigation_options_map' ) ) {
	function aalto_edge_header_main_navigation_options_map() {
		$hide_dep_options = aalto_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = aalto_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'aalto' ),
		...
		aalto_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'aalto' )
			)
		);
		
		$drop_down_group = aalto_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'aalto' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'aalto' )
			)
		);
		
		$drop_down_row1 = aalto_edge_add_admin_row(
			array(
		...
		aalto_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'aalto' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'aalto' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'aalto' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'aalto' )
				)
			)
		);
		...
		$first_level_group = aalto_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '1st Level Menu', 'aalto' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'aalto' )
			)
		);
		...
		$first_level_row3 = aalto_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'aalto' ),
			)
		);
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'aalto' ),
			)
		);
		
		$first_level_row4 = aalto_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'aalto' ),
			)
		);
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'aalto' ),
			)
		);
		
		$first_level_row5 = aalto_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = aalto_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = aalto_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'aalto' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = aalto_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'aalto' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'aalto' )
			)
		);
		...
		aalto_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'aalto' )
			)
		);
		...
		$second_level_row3 = aalto_edge_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_wide_group = aalto_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'aalto' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'aalto' )
			)
		);
		
		$second_level_wide_row1 = aalto_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = aalto_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = aalto_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = aalto_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'aalto' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'aalto' )
			)
		);
		...
		$third_level_row3 = aalto_edge_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = aalto_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'aalto' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'aalto' )
			)
		);
		
		$third_level_wide_row1 = aalto_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = aalto_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = aalto_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'aalto_edge_header_main_navigation_options_map', 'aalto_edge_header_main_navigation_options_map', 10, 1 );
}