 ...
 */
if ( ! class_exists( 'AaltoEdgeSidebar' ) ) {
	class AaltoEdgeSidebar {
		var $sidebars = array();
		var $stored = "";
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'aalto' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'edgtf_sidebar', EDGE_ROOT . '/framework/admin/assets/js/edgtf-sidebar.js' );
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'aalto') . "' name='edgtf-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'aalto') . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'aalto_edge_custom_widget_args', $args );
