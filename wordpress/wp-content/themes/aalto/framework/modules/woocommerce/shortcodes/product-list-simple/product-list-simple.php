...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Edge Product List - Simple', 'aalto' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'aalto' )         => 'sale',
								esc_html__( 'Best Sellers', 'aalto' ) => 'best-sellers',
								esc_html__( 'Featured', 'aalto' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'aalto' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
	...
	public function render( $atts, $content = null ) {
		...
		$html = aalto_edge_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
